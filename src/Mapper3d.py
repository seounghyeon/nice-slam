...
from src.common_f import (get_camera_from_tensor, get_samples,
                        get_tensor_from_camera, random_select, proj_3D_2D, ray_to_3D, get_rays_from_uv)
...
class Mapper(object):
    ...
    def optimize_map(self, prev_camera_tensor, gt_depth_prev, gt_color_prev, uv_prev, uv_cur, index_prev, index_cur, i_prev, j_prev, i_cur, j_cur, gt_depth_prev_batch_sift, gt_depth_batch_sift,
                     num_joint_iters, lr_factor, idx, cur_gt_color, cur_gt_depth, gt_cur_c2w, keyframe_dict, keyframe_list, cur_c2w):
        """
    ...
    def run(self):
        ...
        index_prev = None
        index_cur = None
        i_prev, j_prev, i_cur, j_cur, gt_depth_prev_batch_sift, gt_depth_batch_sift = None
        ...
        while (1):
            ...
            for outer_joint_iter in range(outer_joint_iters):
                ...
                _ = self.optimize_map(prev_camera_tensor, gt_depth_prev, gt_color_prev, uv_prev, uv_cur, index_prev, index_cur, i_prev, j_prev, i_cur, j_cur, gt_depth_prev_batch_sift, gt_depth_batch_sift,
                                      num_joint_iters, lr_factor, idx, gt_color, gt_depth,
